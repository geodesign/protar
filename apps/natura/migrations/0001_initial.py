...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='natura2000sites',
            name='site',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='natura.Site'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='intersectionlog',
            name='site',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='natura.Site'),
        ),
        migrations.AddField(
            model_name='impact',
            name='site',
        ...
        migrations.AddField(
            model_name='habitatclass',
            name='site',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='natura.Site'),
        ),
        migrations.AddField(
            model_name='designationstatus',
            name='site',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='natura.Site'),
        ),
        migrations.AddField(
            model_name='cover',
            name='site',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='natura.Site'),
        ),
        migrations.AddField(
            model_name='contacts',
            name='site',
